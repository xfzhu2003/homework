...
class Vector(object):
    ...
    NO_UNIQUE_ORTHOGONAL_COMPONENT_MS = 'No unique orthogonal component'
    ...
    def times_scalar(self, c):
        new_coordinates = [c * Decimal(x) for x in self.coordinates]
        return Vector(new_coordinates)
    ...
    def component_orthogonal_to(self, basis):
        try:
            ...
            if str(e) == self.NO_UNIQUE_PARALLEL_COMPONENT_MSG:
                raise Exception(self.NO_UNIQUE_ORTHOGONAL_COMPONENT_MS)
            else:
                raise e
