...
if not (s[0] == p1 and
                s[1] == p0 and
                s[2] == Plane(normal_vector=Vector([Decimal('-1'), Decimal('-1'), Decimal('1')]),
                              constant_term=Decimal('-3')) and
                s[3] == p3):
    print 'test case 5 failed'

s.multiply_coefficient_and_row(10, 1)
if not (s[0] == p1 and
                s[1] == Plane(normal_vector=Vector([Decimal('10'), Decimal('10'), Decimal('10')]),
                              constant_term=Decimal('10')) and
                s[2] == Plane(normal_vector=Vector([Decimal('-1'), Decimal('-1'), Decimal('1')]),
                              constant_term=Decimal('-3')) and
                s[3] == p3):
...
if not (s[0] == p1 and
                s[1] == Plane(normal_vector=Vector([Decimal('10'), Decimal('11'), Decimal('10')]),
                              constant_term=Decimal('12')) and
                s[2] == Plane(normal_vector=Vector([Decimal('-1'), Decimal('-1'), Decimal('1')]),
                              constant_term=Decimal('-3')) and
                s[3] == p3):
...
if not (s[0] == Plane(normal_vector=Vector([Decimal('-10'), Decimal('-10'), Decimal('-10')]),
                      constant_term=Decimal('-10')) and
                s[1] == Plane(normal_vector=Vector([Decimal('10'), Decimal('11'), Decimal('10')]),
                              constant_term=Decimal('12')) and
                s[2] == Plane(normal_vector=Vector([Decimal('-1'), Decimal('-1'), Decimal('1')]),
